...
fun wordArrayInitialize(){
    ...
    for(i in 4 until 44){
        for(j in 0 until 4){
            ...
            if(i%4 == 0){
                temp = rCon(subWord(rotWord(temp,1)),i/4)
            }
            word[i] = xorWord(temp,word[i-4])
        }
    }
}
